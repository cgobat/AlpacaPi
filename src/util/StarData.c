...
//*	Jul 23,	2023	<MLS> Moved Messier code to MessierData.c
//*****************************************************************************
...
#include	"../../src/core/alpacadriver_helper.h"
#include	"../../src/core/helper_functions.h"
#include	"../../src/core/controller_startup.h"
...
int		myHexData;
char	spectralClassStr[4];

	spectralClassStr[0]	=	objectStruct->spectralClass;
	...
	myHexData	=	objectStruct->NGCtype;
