...
#include	"alpacapi/alpaca_defs.h"
...
//	CONSOLE_DEBUG_W_LONG("gNGCobjectCount\t=",	gNGCobjectCount);
	...
	//------------------------------------------------------------------
	gMessierObjectPtr	=	ReadMessierData(		"data/skytravel/",	kDataSrc_Messier,	&gMessierObjectCount);

	//------------------------------------------------------------------
	gDraperObjectPtr	=	ReadHenryDraperCatalog(	"data/skytravel/",	kDataSrc_Draper,	&gDraperObjectCount);


#ifdef _ENABLE_HYG_
	//------------------------------------------------------------------
	gHYGObjectPtr		=	ReadHYGdata(			"data/skytravel/",	kDataSrc_HYG,		&gHYGObjectCount);
#endif // _ENABLE_HYG_

	//------------------------------------------------------------------
	gConstOutlinePtr	=	ReadConstellationOutlines("data/skytravel/constOutlines.txt", &gConstOutlineCount);
