...
//	{
//		logoImage		=	cvLoadImage("assets/logos/zwo-logo.png",		CV_LOAD_IMAGE_COLOR);
//	}
//	else if (strcasestr(cAlpacaDeviceName, "Atik") != NULL)
//	{
//		logoImage		=	cvLoadImage("assets/logos/atik-logo.png",	CV_LOAD_IMAGE_COLOR);
//	}
//	else if ((strcasestr(cAlpacaDeviceName, "toup") != NULL) || (strcasestr(cAlpacaDeviceName, "GCMOS") != NULL))
//	{
//		logoImage		=	cvLoadImage("assets/logos/touptek-logo.png",	CV_LOAD_IMAGE_COLOR);
//	}
//	else if (strcasestr(cAlpacaDeviceName, "QHY") != NULL)
//	{
//		logoImage		=	cvLoadImage("assets/logos/qhy-logo.png",		CV_LOAD_IMAGE_COLOR);
//	}
	if (logoImage != NULL)
	{
