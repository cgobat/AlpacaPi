...
#include	"../../include/alpacapi/alpaca_defs.h"
...
#include	"widget.h"
#include	"../../include/alpacapi/controller.h"
...
#if defined(_USE_OPENCV_CPP_) || (CV_MAJOR_VERSION >= 4)
//	gAlpacaLogoPtr	=	new cv::imread("assets/logos/AlpacaLogo-vsmall.png", CV_LOAD_IMAGE_COLOR);
//	gAlpacaLogoPtr	=	new cv::Mat("assets/logos/AlpacaLogo-vsmall.png");
	gAlpacaLogo		=	cv::imread("assets/logos/AlpacaLogo-vsmall.png");
...
//	cv::imshow("Logo", gAlpacaLogo);	//Showing actual image
	...
	{
		gAlpacaLogoPtr	=	cvLoadImage("assets/logos/AlpacaLogo-vsmall.png");
	}
#endif
}
