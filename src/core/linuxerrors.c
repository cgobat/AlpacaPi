...
//define	ETIME		62	/* Timer expired */
	case	ENOSR:		strcpy(errorString, "(63) Out of streams resources");		break;
...
//define	ETOOMANYREFS	109	/* Too many references: cannot splice */
	...
	case	EALREADY:		strcpy(errorString, "(114) Operation already in progress");	break;
	case	EINPROGRESS:	strcpy(errorString, "(115) Operation now in progress");		break;
...
#ifdef EREMOTEIO
	case	EREMOTEIO:		strcpy(errorString, "(121) Remote I/O error");		break;
#endif
